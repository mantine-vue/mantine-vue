...
import type { PasswordToggleIconProps } from './PasswordToggleIcon.types'

defineOptions({ name: 'PasswordToggleIcon' })

const props = withDefaults(defineProps<PasswordToggleIconProps>(), {
  reveal: false,
})
</script>
...
<template>
  ...
  >
    <!-- Transparent backing rect keeps the icon's box the full 256 square. -->
