...
export const Flex = withBoxProps(
  defineComponent({
    ...
    props: {
      ...
      gap: [String, Number, Object] as PropType<StyleProp<string | number>>,
      rowGap: [String, Number, Object] as PropType<StyleProp<string | number>>,
      columnGap: [String, Number, Object] as PropType<StyleProp<string | number>>,
      align: [String, Object] as PropType<StyleProp<string>>,
      justify: [String, Object] as PropType<StyleProp<string>>,
      wrap: [String, Object] as PropType<StyleProp<string>>,
      direction: [String, Object] as PropType<StyleProp<string>>,
