...
interface ScheduleEventBase<Payload extends EventPayload = EventPayload> {
  ...
  /** Event display mode. Background events render behind regular events and are non-interactive unless the view enables interactive background events. @default 'default' */
