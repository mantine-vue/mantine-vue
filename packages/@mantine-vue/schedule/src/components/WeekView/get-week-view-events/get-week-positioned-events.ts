...
import { findAvailableColumn, type ColumnEvent } from './find-available-column'
...
export function getWeekPositionedEvents({
  ...
  for (const day of weekDays) {
    if (eventOverlapMode === 'cascade') applyCascadeLayout(grouped.regularEvents[day])
    else calculateRegularEventOverlaps(grouped.regularEvents[day])
  }
