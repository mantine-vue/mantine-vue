import { UseSelectionDemos } from '@/demos'
...
<Demo data={UseSelectionDemos.usage} />
...
`UseSelectionInput`, `UseSelectionReturnValue` and `UseSelectionHandlers` types are exported from the `@mantine-vue/hooks` package;
