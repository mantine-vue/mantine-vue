import { DayViewDemos, MonthViewDemos, ScheduleDemos, WeekViewDemos, YearViewDemos } from '@/demos'
...
`@mantine-vue/schedule` supports recurring events via [RFC 5545](https://datatracker.ietf.org/doc/html/rfc5545)
...
```ts
import { expandRecurringEvents } from '@mantine-vue/schedule'
