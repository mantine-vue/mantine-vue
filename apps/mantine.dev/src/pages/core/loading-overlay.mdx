import { LoadingOverlayDemos } from '@/demos'
...
To replace the default loader with any custom content, set `:loader-props="{ children: 'Loading...' }"`.
You can put any Vue node inside `loaderProps.children`:
