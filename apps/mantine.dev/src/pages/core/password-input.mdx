...
The visibility toggle is removed from the tab order by default. Set
`visibilityToggleFocusable` to make it keyboard-focusable; Space and Enter toggle visibility.
