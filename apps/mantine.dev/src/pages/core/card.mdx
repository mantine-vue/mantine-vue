...
<Demo data={CardDemos.horizontal} />

## Polymorphic component

Card is a polymorphic component — you can change its root element with the `component` prop:
...
<template>
  <Card padding="xl">
    ...
    <!-- Content not inside Card.Section will have theme.spacing.xl spacing on all sides -->
...
Note that `Card` relies on mapping direct children and you cannot use wrappers for `Card.Section`:
...
`Card.Section` is also a polymorphic component — you can change its root element:
