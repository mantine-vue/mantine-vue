...
const Demo = defineComponent({
  name: 'ScrollAreaScrollbarsDemo',
  setup() {
    return () =>
      h(
        ScrollArea,
        { w: 300, h: 200, scrollbars: 'y' },
        {
          default: () =>
            h(
              Box,
              { w: 600 },
              {
                default: () => [
                  ...
                  h(
                    ...
                    {
                      default: () =>
                        'As Mega Charizard X, its body and legs are more physically fit, though its arms remain thin. Its skin turns black with a sky-blue underside and soles.',
                    },
                  ),
                ],
              },
