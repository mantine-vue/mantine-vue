...
import { Button, Drawer, FocusTrap, TextInput } from '@mantine-vue/core'
...
import { useDisclosure } from '@mantine-vue/hooks'
import { Drawer, Button, TextInput, FocusTrap } from '@mantine-vue/core'
...
const Demo = defineComponent({
  name: 'DrawerInitialFocusTrapDemo',
  setup() {
    const [opened, { open, close }] = useDisclosure(false)
    return () =>
      h('div', null, [
