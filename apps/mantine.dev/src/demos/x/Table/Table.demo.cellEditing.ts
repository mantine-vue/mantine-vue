...
const columns: MVT_ColumnDef<Person>[] = [
  ...
  ...col,
  // Persist the edited value when the input loses focus.
...
const table = useMantineVueTable<Person>({
  ...
  enableEditing: true,
  // Click a single cell to edit it in place.
...
export const cellEditing: MantineDemo = {
  type: 'code',
  component: Demo,
  code,
}
